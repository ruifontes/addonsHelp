...
addon_info = AddonInfo(
	...
	addon_sourceURL = "https://github.com/ruifontes/addonsHelp",
...
pythonSources: list[str] = ["addon/globalPlugins/addonsHelp/*.py", "addon/installTasks.py"]
